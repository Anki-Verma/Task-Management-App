  ...
  return (
    <Card className="flex flex-col border-2 border-white shadow-none bg-[#EDEDED]">
      ...
      <CardContent className="flex flex-1 items-center pb-0">
        ...
        >
          {/* Wrap the multiple children elements inside a fragment */}
          <>
            <RadialBarChart
              data={chartData}
              endAngle={180}
            ...
            >
              ...
              <RadialBar
                ...
                stackId="a"
                cornerRadius={5}
                fill="var(--chart-2)" // Use the pre-defined chart color variables
                className="stroke-transparent stroke-2"
              />
              <RadialBar
                dataKey="pending"
                fill="var(--chart-1)" // Use the pre-defined chart color variables
                stackId="a"
                cornerRadius={5}
                className="stroke-transparent stroke-2"
              />
