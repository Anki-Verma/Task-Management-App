      ...
      >
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            name="title"
            value={task.title || ""}  // Ensure value is always defined
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            rows={4}
            value={task.description || ""}  // Ensure value is always defined
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            name="priority"
            value={task.priority || "low"}  // Default to "low" if undefined
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            type="date"
            name="dueDate"
            value={task.dueDate || ""}  // Ensure this is always defined
          ...
          <div className="flex items-center justify-between bg-[#F9F9F9] p-2 rounded-md border">
            ...
            <div>
              <select
                ...
                className="bg-[#F9F9F9] p-2 rounded-md border cursor-pointer"
                name="completed"
                value={task.completed !== undefined ? task.completed.toString() : "false"}  // Default to "false"
